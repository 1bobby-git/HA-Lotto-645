...
**로컬 공식은 기본 카탈로그 22개 + 기존 연구 확장 2개로 총 24개입니다.** Home Assistant AI와 다중 조합 미리보기는 별도 기능으로 중복 집계하지 않습니다. 기본 선택은 **부분 Fisher–Yates 1개**이며 기존 설정·엔티티·구매 기록·중앙값 합의는 유지합니다. 새 공식은 자동 활성화하지 않습니다.

**조건 지정 균등 생성·개인 행운 번호·계열별 다수결**을 선택할 수 있습니다. 조건 설정은 **구성 → 조건 지정 생성 설정**, 개인 키워드는 **구성 → 개인 행운 번호 설정**에서 저장한 다음 추천 설정에서 해당 공식을 선택하세요. 기본 조건은 제한 없음이며 저장한 조건을 기존 다른 공식에 강제 적용하지 않습니다.

**다중 조합 설계**는 패널 **한눈에 → 다중 조합 설계**에서 후보 6~45개와 1~5게임을 직접 지정합니다. 번호 배분·3수 커버리지·9후보 3게임 휠링을 제공합니다. 미리보기 결과를 구매·리뷰 기록에 자동 저장하지 않습니다. [사용법과 검증 경계](docs/RECOMMENDED_FORMULAS.md)
...
20. [재미 공식 · 개인 행운 번호](docs/methods/personal_lucky.md)
21. [합의 추천 · 선택 공식 중앙값](docs/methods/selected_median_consensus.md)
22. [합의 추천 · 계열별 다수결](docs/methods/selected_vote_consensus.md)

**기존 연구 확장 2개:** 비인기 패턴 회피, 3수 커버리지 보완. [연구 확장 안내](docs/research-formulas.md)

먼저 [공통 계산 원리·점수 읽는 법](docs/FORMULAS.md)을 확인하면 각 공식의 차이를 비교하기 쉽습니다. 위 기본 목록 22개와 아래 연구 확장 2개는 **로컬 추첨 공식**이며 Home Assistant AI 추천은 별도 기능입니다.
