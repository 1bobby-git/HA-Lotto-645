...
async def verify_component_design(page: Page) -> None:
    ...
    await page.evaluate("""async () => {
        const { applyComponentDesign } = await import('/lotto_645_static/lotto-panel-design.js?v=1.13.0');
    ...
    assert await page.locator('.component-version').text_content() == 'v1.13.0'
    checked = 0
