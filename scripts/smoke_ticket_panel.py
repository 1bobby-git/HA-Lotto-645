...
async def run():
    ...
    async with async_playwright() as pw:
        ...
        resources = {f'/lotto_645_static/{name}': WWW / name for name in (
            'jsQR.js', 'lotto-panel-shell.js', 'lotto-panel.js', 'lotto-panel-research.js', 'lotto-panel-portfolio.js', 'lotto-panel-core.js', 'lotto-panel-view.js', 'lotto-panel-design.js', 'lotto-panel-tools.js', 'lotto-panel-validation.js', 'lotto-panel-validation-details.js'
        )}
