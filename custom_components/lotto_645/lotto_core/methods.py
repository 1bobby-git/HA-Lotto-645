...
METHOD_CROWD_AVOIDANCE: Final = "crowd_pattern_avoidance"
...
METHODS: Final[tuple[MethodDefinition, ...]] = (
    ...
    MethodDefinition(
        METHOD_CROWD_AVOIDANCE,
        "분할 위험 참고 · 비인기 패턴 회피", "구매 성향 휴리스틱",
        "생일 범위·긴 연속수·등차수열·끝자리 집중 같은 구매 선호 대리지표를 피합니다. 실제 구매 데이터로 학습한 모형이 아니며 당첨확률·기대상금 증가를 보장하지 않습니다.",
        {}, pool_size=45, sampling="crowd_pattern_avoidance",
    ),
    MethodDefinition(
