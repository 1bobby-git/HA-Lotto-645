...
METHODS: Final[tuple[MethodDefinition, ...]] = (
    ...
    MethodDefinition(
        ...
        "독창 패턴 · 다중시간대 공명",
        "독창 분석",
        "최근 30·120·260회와 전체 구간의 잔차 차이·변화 속도·곡률을 함께 보는 방식입니다. 전이·그래프·간격을 보조로 사용해 한 구간의 일시적 급등에만 끌려가지 않도록 구성했습니다.",
    ...
    MethodDefinition(
        ...
        "공개 공식 · 이월수",
        "공개 분석식",
        "직전 회차 번호가 다음 회차에 일부 다시 등장하는 이월수 관찰을 활용합니다. 이월 개수 0~6개의 정확한 초기하분포를 상대점수로 쓰고 전이·최근 빈도·번호쌍을 함께 봅니다. 개수 집단의 확률이지 개별 조합 당첨확률이 아닙니다.",
    ...
    MethodDefinition(
        ...
        (
            ...
            "연주·월주·일주·시주, 지장간 비율, 십신 10종, 통근·투출, 격국 후보를 계산하고 "
            "억부·조후·통관·병약 보완 후보와 대운·세운·월운·일시진의 합충형파해를 점수에 반영합니다. "
            "문서 오류인 일진 기준표는 제외하고 한국 음력·절기 절대시각을 검산합니다. 번호 변환과 강약 점수는 자체 휴리스틱입니다. "
