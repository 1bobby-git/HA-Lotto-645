...
import './lotto-panel.js?v=2.4.0';
import { PANEL_TAG } from './lotto-panel-core.js?v=2.4.0';
import { applyComponentDesign } from './lotto-panel-design.js?v=2.4.0';
import { applyPanelTools } from './lotto-panel-tools.js?v=2.4.0';
...
lotto-panel-tools-v2-4-0{display:block!important;height:0!important;min-height:0!important;margin:0!important;overflow:visible!important}
...
Panel.prototype.render = function (...args) {
  ...
  if (root) {
    ...
    ballStyle.setAttribute('data-lotto-official-ball-colors', '2.4.0');
