...
import './lotto-panel.js?v=1.18.1';
...
import { applyHistoricalValidation } from './lotto-panel-validation.js?v=1.18.1';
...
Panel.prototype.render = function (...args) {
  ...
  if (root && appHeader && componentRow) {
    ...
    hostStyle.setAttribute('data-lotto-ha-host-header', '1.18.1');
  ...
  if (root) {
    ...
    ballStyle.setAttribute('data-lotto-official-ball-colors', '1.18.1');
