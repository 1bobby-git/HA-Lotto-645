...
import './lotto-panel.js?v=2.2.2';
import { PANEL_TAG } from './lotto-panel-core.js?v=2.2.2';
import { applyComponentDesign } from './lotto-panel-design.js?v=2.2.2';
import { applyPanelTools, countdownState } from './lotto-panel-tools.js?v=2.2.2';
...
lotto-panel-tools-v2-2-2{display:block!important;height:0!important;min-height:0!important;margin:0!important;overflow:visible!important}
@container wallet (max-width:560px){
...
const Tools = customElements.get('lotto-panel-tools-v2-2-2');
...
Panel.prototype.render = function (...args) {
  ...
  if (root && appHeader && componentRow) {
    ...
    hostStyle.setAttribute('data-lotto-ha-host-header', '2.2.2');
  ...
  if (root) {
    ...
    ballStyle.setAttribute('data-lotto-official-ball-colors', '2.2.2');
    ballStyle.textContent = LOTTO_BALL_AND_COUNTDOWN_STYLE;
  }
  const tools = root?.querySelector('lotto-panel-tools-v2-2-2');
  if (tools) {
