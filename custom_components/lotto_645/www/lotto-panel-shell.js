...
import './lotto-panel.js?v=2.3.4';
import { PANEL_TAG } from './lotto-panel-core.js?v=2.3.4';
import { applyComponentDesign } from './lotto-panel-design.js?v=2.3.4';
import { applyPanelTools } from './lotto-panel-tools.js?v=2.3.4';
...
lotto-panel-tools-v2-3-4{display:block!important;height:0!important;min-height:0!important;margin:0!important;overflow:visible!important}
...
Panel.prototype.render = function (...args) {
  ...
  if (root && appHeader && componentRow) {
    ...
    hostStyle.setAttribute('data-lotto-ha-host-header', '2.3.4');
  ...
  if (root) {
    ...
    ballStyle.setAttribute('data-lotto-official-ball-colors', '2.3.4');
    ballStyle.textContent = LOTTO_BALL_AND_COUNTDOWN_STYLE;
  }
  const tools = root?.querySelector('lotto-panel-tools-v2-3-4');
  if (tools) {
