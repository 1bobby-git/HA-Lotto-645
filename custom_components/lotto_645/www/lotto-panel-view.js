...
.ticket-swiper-nav{display:flex;align-items:center;justify-content:center;gap:4px;margin-top:6px;min-height:32px}
...
.small-print{display:flex;align-items:flex-start;gap:7px;color:var(--muted);font-size:11px;margin:12px 2px 0;line-height:1.7}.small-print svg{width:14px;height:14px;margin-top:3px}
...
.upcoming-hero{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(240px,.8fr);gap:16px;padding:22px 24px;border:1px solid var(--line);border-radius:20px;background:var(--surface);box-shadow:var(--shadow);margin-bottom:14px}
...
.upcoming-clock{margin-top:12px}.upcoming-clock .clock-label{display:block;font-size:11px;color:var(--muted);margin-bottom:2px}.upcoming-clock strong{display:block;font-size:26px;line-height:1.35;font-variant-numeric:tabular-nums;letter-spacing:-.03em;overflow-wrap:anywhere}.upcoming-clock small{display:block;margin-top:3px;color:var(--muted);font-size:11px;overflow-wrap:anywhere}
.hero-actions{display:flex;align-items:center;flex-wrap:wrap;gap:8px 12px;margin-top:12px}.hero-actions button{min-height:40px;font-size:12px;flex:none}.hero-ticket-summary{display:flex;align-items:center;flex-wrap:wrap;gap:6px 8px;min-width:0;color:var(--muted);font-size:11px}.hero-ticket-summary[hidden]{display:none}.hero-ticket-summary>strong{color:var(--ink);font-size:11px;white-space:nowrap}.hero-ticket-items{display:flex;flex-wrap:wrap;gap:5px}.hero-ticket-chip{display:inline-flex;align-items:center;min-height:26px;padding:3px 7px;border:1px solid var(--line);border-radius:999px;background:var(--soft);color:var(--muted);font-size:10px;white-space:nowrap}
.upcoming-status{display:grid;gap:8px;align-content:center}.status-card{padding:13px 15px;border-radius:14px;background:var(--soft);min-width:0}.status-card span{display:block;font-size:10px;color:var(--muted);margin-bottom:3px}.status-card strong{display:block;font-size:13px;line-height:1.6;overflow-wrap:anywhere}
.draw-stage.last-draw{margin-bottom:0;padding:18px 22px 0}.draw-stage.last-draw .draw-main{grid-template-columns:minmax(145px,190px) minmax(0,1fr);gap:18px;min-height:78px}.draw-stage.last-draw .draw-kicker{font-weight:700}.draw-stage.last-draw h2{font-size:26px;white-space:nowrap}.draw-stage.last-draw .draw-numbers{--ball-size:48px;gap:9px;min-height:66px}.draw-stage.last-draw .draw-numbers .ball{font-size:19px}.draw-stage.last-draw .draw-foot{margin-top:12px;padding:12px 0;min-height:58px}.draw-stage.last-draw .draw-details summary{min-height:40px}
.overview-grid{display:grid;grid-template-columns:minmax(0,1fr) minmax(220px,260px);gap:14px;margin-top:14px;align-items:start}
.overview-side{display:grid;gap:8px}.overview-side .import-promo{margin-top:0;min-height:240px}.overview-card{border:1px solid var(--line);border-radius:16px;background:var(--surface);padding:15px 16px}.overview-card h3{font-size:15px}.overview-card p{font-size:11px;color:var(--muted);line-height:1.65;margin-top:4px;overflow-wrap:anywhere}.overview-card button{margin-top:7px;padding-left:0;background:transparent;color:var(--blue);font-size:12px}
      ...
      <section class="upcoming-hero" aria-labelledby="upcoming-round">
        <div class="upcoming-main">
          ...
          <div class="hero-actions">
            <button class="primary" type="button" data-register>복권 등록</button>
            <div id="hero-ticket-summary" class="hero-ticket-summary" hidden>
              <strong id="hero-ticket-total"></strong>
              <div id="hero-ticket-items" class="hero-ticket-items" aria-label="등록 복권 요약"></div>
            </div>
          </div>
        </div>
