...
import './jsQR.js';
import { panelTemplate, parseGame, numberBalls, ticketRows, renderRows, renderPredictionRows, reviewPresentation } from './lotto-panel-view.js?v=2.1.0';

// The exact repository logo selected by the user. Served by the existing HA route.
export const PANEL_TAG = 'lotto-ticket-panel-v2-1-0';
