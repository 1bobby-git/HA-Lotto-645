...
class LottoRecommendationsSensor(Lotto645Entity, SensorEntity):
    ...
    def extra_state_attributes(self) -> dict:
        ...
        return {
            ...
            "official_source_url": SOURCE_RESULT_URL,
            "collection_policy": COLLECTION_POLICY,
            "official_direct_fallback_enabled": self.coordinator.allow_official_fallback,
...
class LottoAiRecommendationSensor(Lotto645Entity, SensorEntity):
    ...
    def native_value(self) -> str:
        data = self.coordinator.data
        if data.ai_recommendation is not None:
            return ", ".join(str(number) for number in data.ai_recommendation.numbers)
    ...
    def extra_state_attributes(self) -> dict:
        ...
        attributes = {
            ...
            "error": data.ai_error,
            "generated_at": data.ai_generated_at.isoformat() if data.ai_generated_at else None,
